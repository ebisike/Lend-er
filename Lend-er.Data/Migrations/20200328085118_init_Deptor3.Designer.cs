...
namespace Lend_er.Data.Migrations
{
    ...
    [Migration("20200328085118_init_Deptor3")]
    partial class init_Deptor3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lend_er.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Lend_er.Entities.Payments", b =>
                {
                    b.HasOne("Lend_er.Entities.Deptors", "deptors")
                        .WithMany("payments")
                        .HasForeignKey("deptorsId");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Lend_er.Data.ApplicationUser", null)
                        .WithMany()
